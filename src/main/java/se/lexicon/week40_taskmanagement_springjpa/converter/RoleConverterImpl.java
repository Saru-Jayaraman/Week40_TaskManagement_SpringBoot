...
public class RoleConverterImpl implements RoleConverter {
    @Override
    public Role toRoleEntity(RoleDTOFormView dto) {
        return Role.builder().id(dto.getId()).name(dto.getName()).build();
    }

    @Override
    public RoleDTOFormView toRoleDTOView(Role entity) {
        return RoleDTOFormView.builder().id(entity.getId()).name(entity.getName()).build();
    }

    @Override
    public Role toRoleEntitySave(RoleDTOFormSave dto) {
        return Role.builder().name(dto.getName()).build();
    }

    @Override
    public RoleDTOForm toRoleDTOForm(RoleDTOFormView viewDTO) {
        return RoleDTOForm.builder().id(viewDTO.getId()).name(viewDTO.getName()).build();
    }
